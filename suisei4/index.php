...
<html lang="en">
  ...
  <div class="offcanvas-header">
    <h5 class="offcanvas-title text-primary" id="offcanvasExampleLabel">APM</h5>
  ...
  <a class="nav-link text-secondary <?php if($page=='pengaduan'){echo'bg-primary text-white';} ?>" href="?page=pengaduan">Pengaduan</a>
</nav>
  </div>
</div>
