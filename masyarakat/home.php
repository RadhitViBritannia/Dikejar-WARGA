...
<div class="card-body">
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <td>
                <a href="hapus.php?id_pengaduan=<?= $data['id_pengaduan'] ?>" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" name="hapus_pengaduan">Hapus</button>
      </div>
      </form> 
    </div>
  </div>
